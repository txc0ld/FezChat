...
struct FriendFinderMapView: View {
            ...
            HStack(spacing: BlipSpacing.md) {
                ...
                Button {
                    ...
                    Image(systemName: "arrow.triangle.turn.up.right.diamond.fill")
                        .font(.custom(BlipFontName.medium, size: 18))
    ...
    private func statusBanner(icon: String, title: String, tint: Color) -> some View {
        HStack(spacing: BlipSpacing.sm) {
            Image(systemName: icon)
                .font(.custom(BlipFontName.medium, size: 13))
            ...
            ZStack {
                ...
                VStack(spacing: 2) {
                    ...
                    if isSelected {
                        VStack(spacing: 1) {
                            Text(friend.displayName)
                                .font(.custom(BlipFontName.semiBold, size: 10))

                            if let distance = friend.distanceText {
                                Text(distance)
                                    .font(.custom(BlipFontName.regular, size: 9))
                            }
                        }
                        .foregroundStyle(.white)
                        .padding(.horizontal, BlipSpacing.sm)
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                Text(beacon.label)
                    .font(.custom(BlipFontName.semiBold, size: 9))
                    .foregroundStyle(.white)
