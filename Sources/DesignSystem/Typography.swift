...
struct BlipTypography: Sendable {
    ...
    /// Hero / marketing text — Bold 40pt
    let display: Font

    /// Large titles — Bold 34pt
    let largeTitle: Font

    /// Section headers — Bold 28pt
    let title2: Font

    /// Sub-section headers — SemiBold 20pt
    let title3: Font

    /// Navigation / tab labels — SemiBold 22pt
    let headline: Font

    /// Secondary labels — SemiBold 15pt
    let subheadline: Font

    /// Body / chat text — Regular 17pt
    let body: Font

    /// Callouts / input labels — Regular 16pt
    let callout: Font

    /// Secondary / metadata — Regular 13pt
    let secondary: Font

    /// Fine print / disclaimers — Regular 13pt
    let footnote: Font

    /// Captions — Medium 11pt
    let caption: Font

    /// Micro labels / badges — Medium 9pt
    ...
    static let system = BlipTypography(
        ...
        title2: .system(size: 28, weight: .bold, design: .default),
