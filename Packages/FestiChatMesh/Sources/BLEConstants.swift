...
/// BLE constants for the FestiChat mesh network (spec Section 5.1).
public enum BLEConstants: Sendable {

    // MARK: - Service & Characteristic UUIDs

    /// Primary FestiChat BLE service UUID.
    public static let serviceUUID = CBUUID(string: "FC000001-0000-1000-8000-00805F9B34FB")

    /// Primary FestiChat BLE characteristic UUID for data exchange.
    ...
    public static let centralRestorationID = "com.festichat.ble.central"

    /// CBPeripheralManager state restoration identifier.
    public static let peripheralRestorationID = "com.festichat.ble.peripheral"
